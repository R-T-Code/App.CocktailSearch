class UI {
    ...
    // Displays drinks with ingridients
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">
                                <ul class="list-group">
                                        ...
                                        ${this.displayIngredgients(drink)}
                                </ul>
                            </p>
    ...
    displaySingleRecipe(recipe){
        ...
        modalIngredients.innerHTML = this.displayIngredgients(recipe);
    }

    // Display a cutom message
    ...
    // Displays favorites from the local storage
